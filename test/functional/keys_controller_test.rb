...
class KeysControllerTest < ActionController::TestCase
  ...
  test "should create key" do
    assert_difference('Key.count') do
      post :create, key: { cantidad: @key.cantidad, descripcion: @key.descripcion, numero: @key.numero }
    end
  ...
  test "should update key" do
    put :update, id: @key, key: { cantidad: @key.cantidad, descripcion: @key.descripcion, numero: @key.numero }
    assert_redirected_to key_path(assigns(:key))
  end
